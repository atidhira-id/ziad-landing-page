...
function ArrowRightIcon({ size = 36, color = "white" }) {
  return (
    <svg
      width={size.toString()}
      height={size.toString()}
...
export { CheckIcon, HamburgerIcon, CloseIcon, ArrowRightIcon };
